...
["0xcfcb74d547d6c35db87bfae23bff2dd2ec63e57c954d5998f16b76ba677e3a1d","0x883a3dc06a4763b1a37897edd52d8f300ef00691ba21dc8fc03637848e7b6df1","0x2ed606cbc81f0fa36567646c2cbe7b47ae79c8b9ffb82eed1642ed91b0755b1b","0xf09c8ae24d518e5b387d19827c85d96a746c5604d3fbc0fe65bb152b7d11d90e","0x9c07d1b712a9559c1d01e7f8b90dc03ad9849456e6d473958e1ac637f06c89d1","0x68a9ea3ca44da30ea6ad4ae962508fc61e27b0fa4c6cc88ef27bf213b1704af8"]
const CONTRACT_NAME = 'PlutoLabNFT';
// const [owner, addr1, addr2, addr3, addr4] = await ethers.getSigners();
const NAME = "Pluto Lab NFT";
const SYMBOL = "PLUTOLABNFT";
describe("PlutoLabNFT", function () {
  ...
  // context(contractName, async() => {
    ...
    beforeEach(async () => {
      ...
      this.Contract = await deployContract(CONTRACT_NAME, [NAME, SYMBOL]);
    ...
    // const tree0 = getMerkle(json.map(item => getAllowedItemHash(item[0], item[1])));
    // // console.log(tree0)
    // const root0 = `0x${tree0.getRoot().toString('hex')}`;
    // console.log(root0)
    // const proof0 = getAllowedItemProof(tree0, "0x6e24f0fF0337edf4af9c67bFf22C402302fc94D3", BigNumber.from(1))
    // const proof1 = getAllowedItemProof(tree0, "0xC6afCd96c220c79a478FF2A3443DF8404Ac59069", BigNumber.from(1))
