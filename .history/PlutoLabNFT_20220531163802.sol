...
contract PlutoLabNFT is ERC1155, Ownable {
  ...
  function setNftStatus(uint _id, uint _amount, uint _whiteListPrice, uint _publicPrice, uint _presaleTime, uint _publicSaleTime, string memory _uri) external onlyOwner {
